  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(onPressed: ()=>Get.to(()=>UpdateDocProfile(isWideScreen, isNarrowScreen,user)), icon: Icon(Icons.edit_note_outlined,color: ColorManager.primary,size: 30,))
        ],
      ...
      body: Column(
        ...
        children: [
          FadeIn(
              ...
              child: profileBanner(context,user)),
          Container(
