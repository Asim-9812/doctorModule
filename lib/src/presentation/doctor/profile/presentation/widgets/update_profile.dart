...
import 'package:medical_app/src/presentation/doctor/profile/domain/services/update_profile_service.dart';
...
class _UpdateDocProfileState extends ConsumerState<UpdateDocProfile> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.user.profileImage == null) {
      ...
      profileImage = NetworkImage('$Api/${widget.user.profileImage}');
    }
