        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              Row(
                children: [
                  Text('Account & Settings',style: getMediumStyle(color: ColorManager.black,fontSize: 20),),
                  w10,
                  Container(
                    width: 150.w,
                    child: Divider(
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              Row(
                children: [
                  Text('Help & Support',style: getMediumStyle(color: ColorManager.black,fontSize: 20),),
                  w10,
                  Container(
                    width: 180.w,
                    child: Divider(
