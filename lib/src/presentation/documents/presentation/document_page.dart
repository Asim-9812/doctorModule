...
import 'package:medical_app/src/presentation/documents/add_documents/presentation/add_document_page.dart';
import 'package:medical_app/src/presentation/documents/search_documents/presentation/search_document_page.dart';
    ...
    return FadeIn(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          actions: [
            IconButton(
              onPressed: ()=>Get.to(()=>AddDocumentPage(),transition: Transition.rightToLeftWithFade,duration: Duration(milliseconds: 500))
              , icon: FaIcon(Icons.add),color: Colors.blue,),
            IconButton(onPressed: ()=>Get.to(()=>SearchDocumentPage(),transition:Transition.rightToLeftWithFade)
