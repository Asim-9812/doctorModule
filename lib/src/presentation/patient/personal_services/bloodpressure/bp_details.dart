...
class BPDetails extends StatefulWidget {
  const BPDetails({super.key});

  @override
  State<BPDetails> createState() => _SugarTestDetailsState();
}

class _SugarTestDetailsState extends State<BPDetails> {
