...
class XrayDetails extends StatefulWidget {
  const XrayDetails({super.key});

  @override
  State<XrayDetails> createState() => _XrayDetailsState();
}

class _XrayDetailsState extends State<XrayDetails> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: ColorManager.white,
        elevation: 1,
        title: Text('X-ray-NAME',style: getMediumStyle(color: ColorManager.black,fontSize: 20),),
                          ...
                          ExpansionPanel(
                            ...
                            headerBuilder: (BuildContext context, bool isExpanded) {
                              return ListTile(
                                ...
                                title: Text('X-Ray images', style: getMediumStyle(
