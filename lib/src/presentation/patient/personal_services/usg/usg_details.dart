...
class USGDetails extends StatefulWidget {
  const USGDetails({super.key});

  @override
  State<USGDetails> createState() => _USGDetailsState();
}

class _USGDetailsState extends State<USGDetails> {
                          ...
                          ExpansionPanel(
                            ...
                            headerBuilder: (BuildContext context, bool isExpanded) {
                              return ListTile(
                                ...
                                title: Text('USG images', style: getMediumStyle(
