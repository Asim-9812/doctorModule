...
class MRIDetails extends StatefulWidget {
  const MRIDetails({super.key});

  @override
  State<MRIDetails> createState() => _MRIDetailsState();
}

class _MRIDetailsState extends State<MRIDetails> {
