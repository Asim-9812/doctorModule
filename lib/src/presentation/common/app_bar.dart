          ...
          Padding(
            ...
            Expanded(
                child: Padding(
                  ...
                  child: Center(child: Text(titleText, style: getSemiBoldStyle(color: ColorManager.black, fontSize: 22),)),
                ),
            ),
          ],
        ) : Center(
          child: Text(titleText, style: getSemiBoldStyle(color: ColorManager.black, fontSize: 22),
          ),
        ),
      ),
    );
