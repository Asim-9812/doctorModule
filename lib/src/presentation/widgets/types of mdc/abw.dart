...
class ABW extends StatefulWidget {
  const ABW({super.key});

  @override
  State<ABW> createState() => _BSAState();
}

class _BSAState extends State<ABW> {
  int frequency = 0;
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text('3. Gender',style: getRegularStyle(color: ColorManager.black),),
                      Row(
                        mainAxisSize: MainAxisSize.max,
                        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                        children: [
